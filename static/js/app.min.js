!function (n) {
    ...
    t.prototype.initMenu = function () {
        ...
        n(".side-nav").length && (
            ...
            n(".side-nav li [data-bs-toggle='collapse']").on("click", function (t) { return !1 }),
            t.on({
            ...
            n(".side-nav a").each(function () {
                ...
                this.href == o && (n(this).addClass("active"),
                    ...
                    n(this).parent().parent().parent().parent().parent().parent().parent().addClass("menuitem-active"), "wrapper" !== (e = n(this).parent().parent().parent().parent().parent().parent().parent().parent().parent()).attr("id") && e.addClass("show"),
    ...
    }, t.prototype.init = function () { this.initMenu() }, n.LeftSidebar = new t, n.LeftSidebar.Constructor = t
}
