!function (i) {
    ...
    e.prototype.initCharts = function () {
        ...
        r = { 
            ...
            series: [{ name: "Views", data: function (e) { for (var t = [], a = 0; a < e; a++)t.push(Math.floor(90 * Math.random()) + 10); return t }(10) }], 
            zoom: { enabled: !1 }, 
            legend: { show: !1 }, 
            colors: a, 
            ...
            fill: { 
                ...
                gradient: { 
                    ...
                    type: "horizontal", 
                    shadeIntensity: .25, 
                    gradientToColors: void 0, opacityFrom: 1, opacityTo: 1, stops: [0, 100, 100, 100] } 
                }, 
            tooltip: { 
        ...
        r = { chart: { height: 320, type: "bar" }, plotOptions: { bar: { horizontal: !0 } }, colors: a, dataLabels: { enabled: !1 }, series: [{ name: "Sessions", data: [90, 75, 60, 50, 45, 36, 28, 20, 15, 12] }], xaxis: { categories: ["India", "China", "United States", "Japan", "France", "Italy", "Netherlands", "United Kingdom", "Canada", "South Korea"], axisBorder: { show: !1 }, labels: { formatter: function (e) { return e + "%" } } }, grid: { strokeDashArray: [5] } }; 
        
        new ApexCharts(document.querySelector("#country-chart"), r).render(); 
        a = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]; 
        (o = i("#sessions-os").data("colors")) && (a = o.split(",")); 
        r = { chart: { height: 268, type: "radialBar" }, plotOptions: { radialBar: { dataLabels: { name: { fontSize: "22px" }, value: { fontSize: "16px" }, total: { show: !0, label: "OS", formatter: function (e) { return 8541 } } } } }, colors: a, series: [44, 55, 67, 83], labels: ["Windows", "Macintosh", "Linux", "Android"] }; 
    ...
    e.prototype.initMaps = function () { 
        0 < i("#world-map-markers").length && i("#world-map-markers").vectorMap({ 
            map: "world_mill_en", normalizeFunction: "polynomial", hoverOpacity: .7, 
            hoverColor: !1, regionStyle: { initial: { fill: "rgba(93,106,120,0.2)" } 
        }, 
        ...
        e.prototype.init = function () { 
            ...
            this.initCharts(), this.initMaps(), window.setInterval(function () { 
                ...
                i("#active-views-count").text(Math.floor(Math.random() * e + 200)) }, 2e3) 
